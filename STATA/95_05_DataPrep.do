*** NOTE: I have to make a separate DO file for 1995 and 2005 because I switched the columns and rows.  economy is in columns (rather than partner) and partner in ROWS. ****
set more off
...
import excel "2005ExportsMatrix.xlsx", sheet(`x') cellrange(A4:HS227) firstrow
rename PARTNER economy
drop in 1 //source country in columns

//cleaning dataset -- THIS IS ECONOMY.
